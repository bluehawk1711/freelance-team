...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "relative size-10 cursor-pointer rounded-full p-0 transition-all duration-300 active:scale-95 flex items-center justify-center hover:bg-muted",
        className,
      )}
      onClick={toggleTheme}
    ...
    >
      ...
      >
        {isDark ? (
          <Moon className="size-5 text-foreground" aria-hidden="true" />
        ) : (
